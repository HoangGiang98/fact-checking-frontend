    ...
    return (
      <div className="search-and-more">
        ...
        >
          ...
          <Grid item xs={12} className={classes.resultsMargin}>
            <Typography variant="h4" gutterBottom>
              {first_answer.claim} ? <ThumbUpIcon fontSize="inherit" />
            </Typography>
          </Grid>
          {first_answer.answers.map((answer) => (
          ...
          <Grid item xs={12} className={classes.resultsMargin}>
            <Typography variant="h4" gutterBottom>
              {first_answer.claim} ? <ThumbDownIcon fontSize="inherit" />
            </Typography>
          </Grid>
          ...
          <Grid item xs={12} className={classes.resultsMargin}>
            <Typography variant="h4" gutterBottom>
              {first_answer.claim} ? <ThumbsUpDownIcon fontSize="inherit" />
            </Typography>
          </Grid>
